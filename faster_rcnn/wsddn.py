...
class WSDDN(nn.Module):
	...
	def forward(self,
		...
		# ------------------------------------------ Batched Version ------------------------------------------
		# roi_class_logits = roi_class_logits.view(N, -1, self.n_classes) # num_images x rois_per_image x 20
		# roi_det_logits = roi_det_logits.view(N, -1, self.n_classes) # num_images x rois_per_image x 20
		# ------------------------------------------ Batched Version ------------------------------------------
